...
UnityBuildActions.Arguments.BuildTargetExecutable = "AutoCakeExample";
...
UnityBuildActions.PackageFilePath = DirectoryPath.FromString(targetDir).Combine("zip").CombineWithFilePath("AutoCakeExample.zip");
